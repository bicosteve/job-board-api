...
from app.utils.exceptions import InvalidCredentialsError, UserExistError
...
class TestAdminControllers(unittest.TestCase):
    ...
    @patch(
        "app.controllers.admin_controllers.Helpers.generate_verification_code",
        return_value="123456",
    )
    @patch(
        "app.controllers.admin_controllers.NotificationService.send_verification_code",
        return_value=True,
    )
    @patch("app.controllers.admin_controllers.AdminService.add_admin_user")
    def test_register_admin_success(
        self, mock_add_admin, mock_notify, mock_code, mock_load
    ):
    ...
    @patch(
        "app.controllers.admin_controllers.RegisterAdminSchema.load",
        side_effect=ValidationError("bad payload"),
    )
    ...
    @patch("app.controllers.admin_controllers.RegisterAdminSchema.load")
    @patch(
        "app.controllers.admin_controllers.AdminService.add_admin_user",
        return_value=None,
    )
    ...
    @patch(
        "app.controllers.admin_controllers.AdminService.add_admin_user",
        side_effect=UserExistError("exists"),
    )
    ...
    @patch("app.controllers.admin_controllers.LoginAdminSchema.load")
    @patch(
        "app.controllers.admin_controllers.AdminService.get_admin_user",
        return_value=None,
    )
    ...
    @patch(
        "app.controllers.admin_controllers.LoginAdminSchema.load",
        side_effect=ValidationError("bad payload"),
    )
    ...
    @patch("app.controllers.admin_controllers.VerifyAdminSchema.load")
    @patch(
        "app.controllers.admin_controllers.AdminService.verify_admin_user",
        return_value=None,
    )
    ...
    @patch(
        "app.controllers.admin_controllers.VerifyAdminSchema.load",
        side_effect=ValidationError("bad payload"),
    )
