...
class TestAdminService(unittest.TestCase):
    ...
    @patch(
        "app.services.admin_service.AdminRepository.find_admin_by_id", return_value=None
    )
    ...
    # --- get_admin_user ---
    @patch(
        "app.services.admin_service.Security.create_jwt_token", return_value="jwt-token"
    )
    ...
    @patch(
        "app.services.admin_service.AdminRepository.find_admin_by_email",
        return_value=None,
    )
    ...
    @patch(
        "app.services.admin_service.BaseCache.store_verification_code",
        return_value=True,
    )
    ...
    def test_add_admin_user_repo_error(
        self, mock_find, mock_hash, mock_store, mock_add
    ):
        data = {
            "email": self.email,
            "password": self.password,
    ...
    # --- verify_admin_user ---
    @patch(
        "app.services.admin_service.AdminRepository.update_admin_status", return_value=1
    )
    ...
    def test_verify_admin_user_success(self, mock_verify, mock_update):
        data = {"email": self.email, "active_status": 1, "verification_code": "123456"}
    ...
    @patch(
        "app.services.admin_service.AdminRepository.update_admin_status",
        return_value=None,
    )
    @patch("app.services.admin_service.BaseCache.verify_code", return_value=True)
    ...
    @patch(
        "app.services.admin_service.AdminRepository.update_admin_status", return_value=0
    )
    @patch("app.services.admin_service.BaseCache.verify_code", return_value=True)
    ...
    @patch(
        "app.services.admin_service.BaseCache.store_verification_code",
        side_effect=GenericRedisError("fail"),
    )
