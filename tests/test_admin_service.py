...
class TestAdminService(unittest.TestCase):
    ...
    # --- get_admin_user ---
    @patch("app.services.admin_service.Security.create_jwt_token",
    ...
    @patch("app.services.admin_service.Security.hash_password",
           return_value="hashedpw")
    @patch(
        "app.services.admin_service.AdminRepository.find_admin_by_email",
        return_value=None,
    )
    def test_add_admin_user_success(
            self,
            mock_find,
            mock_hash,
            mock_store,
    ...
    def test_add_admin_user_repo_none(
            self,
            mock_find,
            mock_hash,
            mock_store,
